        ...
        <table class="mt-4 min-w-full divide-y divide-gray-200 border">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th class="px-6 py-3 bg-gray-50 text-left">
                        <span class="text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Precio
                            Unitario</span>
                    </th>
                    <th class="px-6 py-3 bg-gray-50 text-left">
                        <span class="text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Cantidad de
                            Productos</span>
                    </th>
                    <th class="px-6 py-3 bg-gray-50 text-left">
                ...
                <tr v-for="product in products" :key="product.id">
                    ...
                    <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-900">
                        <label class="relative inline-flex items-center mr-5 cursor-pointer">
                            ...
                            <span class="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">Inhabilitado</span>
                        </label>
                    </td>
                    <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-900">
